...
<body>
	...
	<div style="background-color: white; width: 90%; height: 800px; margin: 0 auto;">
		...
		<div style="width: 10%; height: 100%; float: left; position: absolute; margin-top: 70px;" class="d-flex flex-column mb-3">
			<!-- 투표한 사람들 리스트 나타내주기 -->
			<c:forEach var="member" items="${completeMembers }">
				<div style="width: 100%; height: 12.5%;">
					<div style="height: 70%;" align="center">
						<i class="fas fa-user-check" style="font-size: 30pt; margin: 12px auto;"></i>
					</div>
					<div style="height: 30%;">
						<div style="width: 30%; height: 100%; float: left;">
							<span style="float: right; background-color: #79bd9a; border: 1px; border-radius: 5px;">${member.usLv }</span>
						</div>
						<div style="width: 40%; height: 100%; float: left;" align="center">
			...
			<c:forEach var="member" items="${progressMembers }">
				<div style="width: 100%; height: 12.5%;">
					<div style="height: 70%;" align="center">
						<i class="fas fa-user" style="font-size: 30pt; margin: 12px auto;"></i>
					</div>
					<div style="height: 30%;">
						<div style="width: 30%; height: 100%; float: left;">
							<span style="float: right; background-color: #79bd9a; border: 1px; border-radius: 5px;">${member.usLv }</span>
		...
		<div style="width: 50%; height: 30%; margin: 0 auto; margin-top: 80px; border: 1px solid black;" align="center" class="d-flex justify-content-center mb-3">
			<c:forEach var="leaders" items="${leaders }">
				<label for="${leaders.usId }" class="user" style="width: 33.333%; height: 60%; margin: 50px auto;">
					<div style="height: 70%;">
		...
		<form action="start_display_page3.action" id="myForm" method="get">
			<input type="text" name="reTicket" value="1" style="display: none;">
			<c:forEach var="leaders" items="${leaders }">
				<input type="radio" id="${leaders.usId }" name="selecter" value="${leaders.usId}" style="height: 10px; display: none;" />
			</c:forEach>
		</form>
