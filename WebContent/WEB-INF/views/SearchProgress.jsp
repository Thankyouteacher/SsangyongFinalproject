		...
		$(document).ready(function()
		{
			...
			$("#findList").click(function()
			{
				...
				if(findCategory == "skName")
					str = 'findlistprogress.action?acContent=null&suContent=null&skContent=' + findValue;
				else if(findCategory == "acName")
					str = 'findlistprogress.action?suContent=null&skContent=null&acContent=' + findValue;
				else if(findCategory == "sname")
					str = 'findlistprogress.action?skContent=null&acContent=null&suContent=' + findValue;
				else
					str = 'findlistprogress.action?findCategory=' + findCategory + "&findValue=" + findValue;
