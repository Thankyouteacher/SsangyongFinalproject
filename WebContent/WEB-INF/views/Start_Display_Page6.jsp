...
<body>
	...
	<div style="background-color: white; width: 90%; height: 800px; margin: 0 auto;">
		...
		<dl style="width: 50%; height: 40%; margin: 100px auto;" align="center">
			<h3>프로젝트 모드를 선택하세요.</h3>
			<br>
			<br>
			<h1 style="font-weight: bold; color: #3b8686">[꼭 알아두세요!]</h1>
			<h1>
				'모드 선택' 기간은 <span style="color: #ff7473;">${modeSelectEnd }</span>까지 입니다.
			</h1>
			<h1>
				'모드 선택'이 이루어지지 않을경우, <span style="color: #ff7473;">프로젝트는 종료</span>됩니다.
			</h1>

			<dd style="width: 16%; height: 10%; float: right; margin: 50px 0 0 0;">
				<nav>
					<ul class="pager">
						<li><a href="start_display_page7.action" style="width: 100%;">Next</a></li>
					</ul>
				</nav>
			</dd>
		</dl>
