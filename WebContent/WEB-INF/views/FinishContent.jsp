...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		{
			var pid2 = $(this).parent().children().eq(0).val();

			alert(pid2);

			location.href = "team_main.action?pid=" + pid2;
		});
	});
</script>
</head>
<body>
	<c:forEach var="list" items="${projectmainlist4 }">
		<article>
			...
			<div id="mainContent">
				<div class="in" style="height: 10px;">
					...
					<div>
						<input type="text" id="inputBackground" class="form-control" style="width: 95%;" readonly="readonly" value="${list.ppDate }">
					</div>
				</div>
				<div class="in" style="height: 10px;">
					<input type="text" style="width: 85%; background-color: transparent; border: 0; color: gray;" readonly="readonly" value="프로젝트기간">
					<div>
				...
				<div class="in" style="height: 10px;">
					...
					<div>
						<input type="text" id="inputBackground" class="form-control" style="width: 70%;" readonly="readonly" value="${list.peDate }">
					</div>
				</div>
				<div class="in" style="height: 10px;">
			...
			<div id="mainContent">
				...
				<div>
					...
					<!-- 회원 -->
					<c:if test="${usId != 0 }">
						<button type="button" class="button btnn3" id="enter" style="margin-left: 300px;">열람하기 &rarr;</button>
					</c:if>
				</div>
			</div>
