...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		$(".AdminAccount").click(function()
		{
			...
			var message = confirm("관리자 계정을 부여하시겠습니까?");
			if (message == true)
			{
		...
		<div class="row">
					...
					<div>
						<ul>
							...
							<li class="menu list-group-item a "><a>관리자 계정 관리</a>
								<ul class="hide" style="list-style: none;">
									<li><a href="userlist.action">관리자 계정 조회 </a></li>
			...
			<div class="col-lg-9">
				<div class="card card-outline-secondary my-4"
					...
					<div class="card-header">관리자 계정 관리</div>
					<div class="card-body">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th style="text-align: center">관리자계정 부여</th>
								</tr>
							<tbody>
								<c:forEach var="user" items="${user_list }">
									<tr>
										<th style="text-align: center">${user.num }</th>
										<th style="text-align: center"><a href ="useraccountinfo.action?usId=${user.usId }">${user.uname }</a></th>
										<th style="text-align: center">${user.usId }</th>
										<th style="text-align: center">${user.nickName }</th>
										<th style="text-align: center"><button type="button" class="btn AdminAccount" value="${user.usId }" style=" background-color: #34314c ;color : white; height: 5%">관리자 설정</button></th>
									</tr>
								</c:forEach>
							</tbody>
						</table>
