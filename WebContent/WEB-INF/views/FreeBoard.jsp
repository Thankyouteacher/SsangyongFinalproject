...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		$('.searchBtn').click(function()
		{
			...
			$(location).attr('href', 'searchboard.action?bid=3&category=' + category + "&content=" + content);
		});
		...
		<div class="col-md-9 float-right" style="width: 850px;">
			<table class="table table-hover table-striped" style="text-align: center;">
				...
				<tbody id="tbody" style="text-align: right;">
					...
					<tr onclick="location.href='boardread.action?bid=${lists.bid }&bpid=${lists.bpid }'">
						<th style="text-align: center;">${lists.bpid }</th>
						<th style="text-align: center;">${lists.postTitle }</th>
						<th style="text-align: center;">${lists.nickName }</th>
						<th style="text-align: center;">${lists.createDate }</th>
						<th style="text-align: center;">${lists.click}</th>
					</tr>				
					</c:forEach>
