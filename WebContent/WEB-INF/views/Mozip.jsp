	...
	<div class="container">
		...
		<c:if test="${usId != 0 }">
			<div>
				...
				<div id="panel1" class="button" style="position: relative;"><jsp:include page="MyProcessButton.jsp" /></div>
				<div id="panel2" class="button" style="position: relative;"><jsp:include page="MyFinishButton.jsp" /></div>
				<div id="panel3" class="button" style="position: relative;"><jsp:include page="MyMozipButton.jsp" /></div>
			</div>
		</c:if>
		...
		<div style="display: flex;">
			<div id="lineRemove">
				<a href="moziplist.action?usId=${usId }" class="button" id="selectSituation" style="width: 70px;">모집</a>
				...
				<a href="finishlist.action?usId=${usId }" class="button" id="situation" style="width: 70px;">완료</a>
			</div>
		...
		<div id="searchDiv">
			<jsp:include page="SearchMozip.jsp"></jsp:include>
		</div>		

		<section id="three" class="wrapper align-center">
			<div class="inner">
				<div class="flex-2">
					<jsp:include page="MozipContent.jsp"/>
				</div>
			</div>
		</section>
	</div>
