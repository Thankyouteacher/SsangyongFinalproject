...
<body>
	...
	<div class="container">
		<section style="display: flex; justify-content: center;" >
			<input type="button" class="activeBtn" value="달성한 업적">
			<input type="button" class="inputBtn" value="미달성 업적" id="notAchiBtn">
		</section>
		...
		<section class="content"  style="margin-top: 5px; padding-top: 30px;">
			...
			<c:forEach var="acdto"  items="${aclist }">
				<div class="items">
				<span style="font-size: 20pt; font-weight: bold; margin-bottom: 15px; margin-left: 70px;"> <i class="fas fa-medal" style="font-size: 18pt;"></i>  ${acdto.acName }</span>
