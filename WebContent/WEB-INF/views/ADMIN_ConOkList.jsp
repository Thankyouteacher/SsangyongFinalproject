...
<title>ADMIN_PAGE - 승인한 공모전</title>
<!-- Bootstrap core CSS -->
		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="card card-outline-secondary my-4"
					...
					<div class="card-header">승인한 공모전</div>
					<div class="card-body">
						<form name="form1"  method="get" action="conOk_searchname.action">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th style="text-align: center">승인ID</th>
									<th style="text-align: center">승인날짜</th>
									<th style="text-align: center">공모전ID</th>
								</tr>
							<tbody>
								<c:forEach var="conOk" items="${conOk_list }">
									<tr>
										<th style="text-align: center">${conOk.num }</th>
										<th style="text-align: center">${conOk.name }</th>
										<th style="text-align: center"><a href="conInfo.action?conId=${conOk.conId }">${conOk.subject }</a></th>
										<th style="text-align: center">${conOk.pasId }</th>
										<th style="text-align: center">${conOk.pasDate}</th>
										<th style="text-align: center">${conOk.conId}</th>
									</tr>
								</c:forEach>
							</tbody>
						</table>
