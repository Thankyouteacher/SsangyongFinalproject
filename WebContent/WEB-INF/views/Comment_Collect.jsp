...
<body>
   ...
   <div class="container">
      <section style="display: flex; justify-content: center;" >
         <input type="button" class="inputBtn" value="작성한 게시글 목록" id="boardBtn">
         <input type="button" class="activeBtn" value="작성한 댓글 목록" >
      </section>
         ...
         <c:forEach var="ubdto" items="${ublist }">
            <div class="items" style="padding-left: 25px; padding-right: 25px">
                  <div style="display:flex; flex-direction:column;">
                     ...
                     <span style="font-weight:bold; font-size: 11pt;" >${ubdto.ccontent }</span><br>
