	...
	<div class="container">
		...
		<div style="display: flex;">
			<div id="lineRemove">
				...
				<a href="mozipaddlist.action?usId=${usId }" class="button" id="selectSituation" style="width: 65px;">추가모집</a> 
		...
		<div id="searchDiv">
			<jsp:include page="SearchMozipAdd.jsp"></jsp:include>
		</div>		

		<section id="three" class="wrapper align-center">
			<div class="inner">
				<div class="flex-2">
					<jsp:include page="MozipAddContent.jsp"/>
				</div>
			</div>
		</section>
	</div>
