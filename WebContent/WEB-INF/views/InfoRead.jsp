...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		$('.like').click(function()
		{
			...
			likePid = $(this).parent().children().eq(1).val();
			
			// 테스트
			// alert(likeUsId + " : " + likePid);
			
			$.post("boardlikecheck.action", {usId : likeUsId, bpid : likePid}, function(data)
			{
				$('#' + likePid).attr("value", data.trim());
			});
		});
...
<body>
	...
	<div class="container">
		<p class="h1" style="font-weight: bold;"><a href="board.action?bid=2" style="color: black; text-decoration: none">정보 게시판</a></p>
	</div>
	...
	<div class="container">
		...
		<div class="col-md-3 float-left" style="width: 300px;">
			<div class="col-12" align="left">
				...
				<ul class="list-group" style="color: black;">
					<c:forEach var="boardName" items="${boardName }">
		...
		<div class="col-lg-8 float-right">
			...
			<div align="center">
				<input type="text" value="${usId }" id="likeUsId" hidden/>
				<input type="text" value= "${readData.bpid }" id="likePid" hidden/>
				<input type="text" id="${readData.bpid }" value="${likeCount }"  style="width: 50px; height: 50px; background-color: white;" readonly="readonly"/>
				<label class="like" for="${readData.bpid }" ><i class="far fa-thumbs-up"  style="width: 50px; height: 50px;"></i></label>
				<br />
			</div>
