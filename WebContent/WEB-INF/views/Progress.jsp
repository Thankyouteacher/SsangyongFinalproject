	...
	<div class="container">
		...
		<div style="display: flex;">
			<div id="lineRemove">
				...
				<a href="progresslist.action?usId=${usId }" class="button" id="selectSituation" style="width: 70px;">진행</a> 
		...
		<div id="searchDiv">
			<jsp:include page="SearchProgress.jsp"></jsp:include>
		</div>

		<section id="three" class="wrapper align-center">
			<div class="inner">
				<div class="flex-2">
					<jsp:include page="ProgressContent.jsp"></jsp:include>
				</div>
			</div>
		</section>
	</div>
