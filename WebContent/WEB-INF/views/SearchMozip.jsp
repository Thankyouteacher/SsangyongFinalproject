		...
		$(document).ready(function()
		{
			...
			$("#findList").click(function()
			{
				...
				if(findCategory == "skName")
					str = 'findlistmozip.action?acContent=null&suContent=null&skContent=' + findValue;
				else if(findCategory == "acName")
					str = 'findlistmozip.action?suContent=null&skContent=null&acContent=' + findValue;
				else if(findCategory == "sname")
					str = 'findlistmozip.action?skContent=null&acContent=null&suContent=' + findValue;
				else
					str = 'findlistmozip.action?findCategory=' + findCategory + "&findValue=" + findValue;
