		...
		$(document).ready(function()
		{
			...
			$("#findList").click(function()
			{
				...
				if(findCategory == "skName")
					str = 'findlistmozipadd.action?acContent=null&suContent=null&skContent=' + findValue;
				else if(findCategory == "acName")
					str = 'findlistmozipadd.action?suContent=null&skContent=null&acContent=' + findValue;
				else if(findCategory == "sname")
					str = 'findlistmozipadd.action?skContent=null&acContent=null&suContent=' + findValue;
				else
					str = 'findlistmozipadd.action?findCategory=' + findCategory + "&findValue=" + findValue;
...
<body>
	...
	<form name="searchForm" method="post" style="display: flex; margin-left: 1500px; width: 325px;">
		<select name="findCategory" class="col-md-5" id="findCategory" class="findCategory">
            ...
            <option id="createDate" value="createDate">개설일</option>
            <option id="startDate" value="startDate">시작일</option>
		...
		<div style="display: flex;">  
			<input id="findValue" name="findValue" type="text" class="form-control col-md-5" placeholder="Search" style="background-color: rgba( 255, 255, 255, 0.5 ); pointer-events: auto; width: 300px;">
