...
<body>
<c:forEach var="list" items="${myMainProjectListFinish }">
	<article>
		<div class="blankTop"></div>
			...
			<div id="mainContent">
				<div class="in" style="height: 10px;">
					<input type="text" style="width: 28%; background-color: transparent; border: 0; color: gray;" readonly="readonly" value="레벨">
					<div>
						<input type="text" id="inputBackground" class="form-control" style="width: 75%;" readonly="readonly" value="${list.minLevel }">
					</div>
					~
					<div>
						<input type="text" id="inputBackground" class="form-control" style="width: 75%;" readonly="readonly" value="${list.maxLevel }">
					</div>
				</div>
				<div class="in" style="height: 10px;">
				...
				<div class="in" style="height: 10px; display: flex;">

					<input type="text" style="width: 40%; background-color: transparent; border: 0; color: gray;" readonly="readonly" value="필요기술">
					<div style="display: flex;">
						<c:forEach var="skName" items="${list.skName }">
						<div>
							<input type="text" id="inputBackground" class="form-control" style="width: 350%;" readonly="readonly" value="${skName }">
						</div>	
						</c:forEach>
					</div>
				</div>
			...
			<div id="mainContent">
				<div class="in" style="height: 10px;">
					<input type="text" style="width: 20%; background-color: transparent; border: 0; color: gray;" readonly="readonly" value="지역">
					<div>
						<input type="text" id="inputBackground" class="form-control" style="width: 150%;" readonly="readonly" value="${list.paddress }">
					</div>
				</div>
				<div class="in" style="height: 10px;">
					<input type="text" style="width: 40%; background-color: transparent; border: 0; color: gray;" readonly="readonly" value="소개">
					<div>
				...
				<div>
					...
					<!-- 프로젝트 번호 -->
					<a href="" class="button btnn" id="enter">열람하기 &rarr;</a>
				</div>
			</div>
