		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="card card-outline-secondary my-4"
					...
					<div class="card-header">신고처리 기다리는 유저 목록</div>
					<div class="card-body">
						...
						<table class="table table-striped">
							<thead>
								<tr>
									...
									<th style="text-align: center">신고항목</th>
							...
							<tbody>
								<c:forEach var="receive" items="${receive_list }">
									<tr>
										<th style="text-align: center">${receive.num }</th>
										<th style="text-align: center">${receive.receivedName }</th>
										<th style="text-align: center">${receive.rtName }</th>
										<th style="text-align: center"><a href="receivedinformation.action?num=${receive.num }" >${receive.rpText }</a></th>
										<th style="text-align: center">${receive.rpDate }</th>
										<th style="text-align: center">${receive.receiver }</th>
									</tr>
								</c:forEach> 
							</tbody>
						</table>
