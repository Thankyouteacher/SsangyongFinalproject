...
$().ready(function()
{
   ...
   $("#projectWait").click(function()
   {
      location.href = "projectwait.action";
   });
...
<body>
   ...
   <div class="container">
      <section style="display: flex; justify-content: center;" >
         <input type="button" class="activeBtn" value="진행 중인 프로젝트">
         <input type="button" class="inputBtn" value="대기 중인 프로젝트" id="projectWait">
                        ...
                        <c:forEach var="dto" items="${prjlist }">
                           <div class="items" style="">
                                 <div style="display:flex; flex-direction:column;">
                                    ...
                                    <span>기간　:　${dto.ppDate } ~ ${dto.peDate }</span>
