			...
			<form action="boardinsert.action" method="POST" role="form">
				<div class="form-group" style="font-style: bold;">
					...
					<input type="text" name="postTitle" id="subjectHelp" class="form-control" 
						placeholder="100자 이내만 입력하세요." style="background-color: rgba(255, 255, 255, 0.5); width: 100%;">
				</div>
				...
				<button type="button" class="btn float-center"
					style="width: 90px; height: 40px; background-color: #79bd9a; color: white;" onclick="location.href='board.action?bid=3'">목록으로</button>	
