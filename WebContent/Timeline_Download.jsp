...
<%
	...
	String savePath = root + File.separator + "timeline" + File.separator + "pid" + Integer.parseInt(request.getParameter("pid")) + File.separator + "member" + Integer.parseInt(request.getParameter("usId"));
