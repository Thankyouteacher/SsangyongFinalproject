...
- **Member** : 정광현(팀장), 한현수(기술고문), 황보영, 김동현, 김종범, 이원정 
- **프로젝트 설명**
  ...
  <br/>
  <image src='https://github.com/Thankyouteacher/SsangyongFinalproject/blob/master/images/main.png' width='800px' height='450px'/>
  <br/>
  <image src='https://github.com/Thankyouteacher/SsangyongFinalproject/blob/master/images/detail.png' width='800px' height='450px'/>
  <br/>
- **구현 기능**
